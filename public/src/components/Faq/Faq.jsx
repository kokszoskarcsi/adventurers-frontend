...
import pingvinSVG from "../../assets/pingvin.svg";
import potiSVG from "../../assets/poti.svg";
...
function Faq() {
  ...
  return (
    <div className="Faq">
          ...
          {questions.map((question) => {
            if (question.key == currentID) {
              if (document.body.classList.contains("black")) {
                return (
                  <p
                    style={{ color: "var(--dark_text_color)" }}
                    className="label"
                  >
                    {question.value}
                  </p>
      ...
      <div className="icons">
        <img className="pingvin" src={pingvinSVG}></img>
        <img className="poti" src={potiSVG}></img>
      </div>
    </div>
  );
}
